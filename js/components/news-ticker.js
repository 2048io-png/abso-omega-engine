    ...
    data: function()
    {
        return {
            messages: [
                ...
                "Sprunki Oren Raddy Clukr Fun Bot Vineria Gray brud Garnold OWAKCX Sky Mr. Sun Durple Mr. Tree Simon Tunner Mr. Fun Computer Wenda Pinki Jevin Black"
                ...
                "METa",
                `Uncaught TypeError: Cannot read properties of undefined (reading: "news-ticker")`,
                "It's about the METa",
                "ඞ",
                ...
                "@here",
                "What",
                "Ń̴͇̬̖̘̠͚͔̲͋͛͗Ǫ̷̤͈̘̞̖̂̀ͅ!̶̛̙̋͛̏͐̕̚ ̶͓͍̲͎̠̎̊͂̕ͅͅȒ̷̫̼̩̠ ̸̨̜̳͇̻̈́͐͌͝E̶͖̖̊ ̸̢̛̦͈͍̀͗A̶͕̩͗͗̈́̔̃̚͘ ̶̼̜̹̀C̷͉̥̘̖̗͎̙̪̀̎̈ ̷̘̃H̷̲̺̲̰̓ͅ ̵̖̦̆̀̆̉̔͂͒Ë̸̦̬̰̜̣͕̪͂̍ ̵̛̯̟͖͕̦̈́̉D̷͈͚̻̱͈͔̜̄ ̴͍͕̭̈́͆͑̉͗͠1̴̢̦̈́̀̈́̂̈́̃̃2̸͖̀͒͆5̸̨̧̛̛̠̙̓͌̈́̀̽̚M̷̡̩̫̊̾̉̆̿͜͝͠͝ ̸̰͖̦̘͙̼͖̃͑̓́̈́͂̍̕͜S̸̳͍͓̯͕͗̈̊̇͝ͅ ̷̞͇̝̝̱̦̘̌͌̿̇̕Ṻ̷̩̗͉̏͐̊̅ ̴̟̈́̏̈́̍̎̀͗̓B̷̪̻͍̣͎̒͒̒̂̿̕͝ ̶͖̤͆̀͆Ć̴̢̛͍̬͍̗̹̙̖̐̾̈́͝ ̵̮̭̦͚̖̂̅̃͂̅R̴͕̞̰̼͖̍͑̓̋ ̶̨̝̞̮͍̯͈̿̽̀̊̇̐̚ͅI̶͇̭̳̐́̑̆̒͂̓͘ ̴͎͑̓̍̄̔̾́͒B̴̡̢͚̞̼̗̪̠̈́̽͋͠ ̵̨̧̧̤͓̙͈̥̀͊̈́Ȩ̶̖̖͐̍ ̷̛̠͗̾̄͐͌͌R̶̦͇̬̮͖͇̈̌̍̈́̉̕̕ ̶̰̄̅̊̊̍͘͠S̵̞̤̬̒̌͗̀͋!̶̡̝̪̣͙̹̌̓̉̏͂!̴͎͂̆͋̇͂͘͝!̶͍͉͕͍̍̇̎́͝͝!̶̛͖̈̏͆͐̀͝!̷̝̻̭͌͌͑͐́͐́͝!̵̮̜̓̽̏̆͒̅͗̚͜",
                "Wat",
                "Wot",
                "No",
                "But",
                "Wut",
                "Nu",
                "̴̟̈́̏̈́̍̎̀͗̓BREAK̶̶̶̶̨̝̞̮͍̯͈̰̰̰̿̽̀̊̇̐̄̅̊̊̍̄̅̊̊̍̄̅̊̊̍̚͘͘͘͠͠͠ͅ!̶̡̝̪̣͙̹̌̓̉̏͂!̴͎͂̆͋̇͂͘͝!̶͍͉͕͍̍̇̎́͝͝!̶͍͉͕͍̍̇̎́͝͝",
                "@everyone",
                "unsussy news",
                "In",
                "Woah crazy",
                ...
                "When",
                "E",
                "FEAR THE SUPER AIR - Corrupt X",
                "In 30 mins™",
                "No u",
                "o <- This is Simon from Sprunki",
                "no",
                "nu (ν)",
                "There's a hidden font that isn't avaiable normally",
                "Nu (Ν)",
                "死 傭兵が死亡した場合、プレイヤーは不本意ながら傭兵を失うこともあります。傭兵が死亡した場合、レベルに応じてルビーを支払って復活させるか、埋葬して金を得ることができます。 Burial Gold = 10 × (超越前HZE + 1)のモンスター報酬 復活に必要なルビー数＝10＋ceil(1.5レベル) モバイルでは、金額に Xyliqil レベルが掛けられます。したがって、レベル 1 の傭兵を復活させるには 12 エンシェント ソウルと 1 体を復活させる必要があります。",
                "UwU",
                "<a href='https://tw.2s4.me'>Play tw.2s4.me</a>",
                ...
                "newsticker",
                "Renaultians uses: (No ggg Delete ggg Yes renault Add renault)",
                "Good Game...",
                "天台山寨的是的感觉的回答有人们是个男的还是女的",
                ...
                "new sticker",
                "e - βσηκ",
                "年 116 ユーチューバーのタイプ 全て 加入者 3000万 セックス 男 友達 なし。 敵 あなたのお母さん、嫌いな人、詐欺師、そしてたくさんの良いユーザー チャネルの作成 1907年11月14日 チャンネル年齢 115年",
                "年 7 から 63 の間 ユーチューバーの種類 ぜんぶ 加入者 115 性別 男 友達 なし。 敵 あなたのお母さん、嫌いな人、詐欺師、たくさんの良いユーザー チャンネル作成 2019年11月14日 チャンネルエイジ 2年",
                "(hardcapped)",
                "modding.net",
                "layer name moment",
                "weird themes",
                ...
                "Διαγωνισμός μαγειρικής να μεν εν πάντα τέλεια η κότα η αγαπημένη μου μάρκα",
                "1",
                "Три кота (0+)",
                ...
                "218 Jigger 218",
                "Welcome to tw.2s4.me! Managed by FP (@system2k on Discord) Our domain is shorter by two characters from the original! If you're granted membership on a wall, just refresh",
                "1e420 blaze it.",
                "The cookie is a lie.",
                "Would you to mine 1,000,000 blocks for a free rank?",
                ...
                "Powered by RNG",
                "STOP SPAMMING TNT IN THE CHAT - LIKE AND SUBSCRIBE",
                "Maybe there are new News here? Nope, just the old news...",
                "The Number limit is above 10↑↑308, good luck!",
                "Your ad here",
                "ζ is Fake News!",
                ...
                () => "Get to 100,000,000 -> " + Math.pow(10, Math.random() * 300000.01).toFixed(2) +
                    ". If it's above 1,000,000,000, consider yourself lucky!",
                ...
                () => functions.formatNumber(gane.metaLayer.active ? game.metaLayer.getApproxAlpha() : game.layers[0].resource, 2, 0, 1e9) + " votes recieved today.",
